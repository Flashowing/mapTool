<template>
    <div class='container'>
      <el-menu :default-active='activeIndex' class='el-menu-demo' mode='horizontal' @select='handleSelect'>
        ...
        <el-menu-item index='3' class='hidden-md-and-down'><a href='./doc/index.html' target='_blank'>文档</a></el-menu-item>
        <el-submenu index='2'>
